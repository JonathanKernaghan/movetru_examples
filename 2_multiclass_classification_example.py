...
def evaluate_model(clf: Any, input_features: pd.DataFrame, target_variable: pd.DataFrame, test: bool) -> None:
    ...
    if test:
        ...
        f = sns.heatmap(cm, annot=True).set(title="Confusion Matrix for Test Data Predictions")
